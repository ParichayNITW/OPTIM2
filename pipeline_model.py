...
def solve_pipeline(
    ...
    min_rpm = {}; max_rpm = {}; sfc = {}; elec_cost = {}; peaks_dict = {}
    ...
    result['total_cost'] = float(pyo.value(model.Obj)) + sum(dra_cost_station.values())
    result['total_dra_cost'] = sum(dra_cost_station.values())
    return result
