...
def solve_pipeline(
    ...
    """
    # Adjust the discretisation steps to allow a finer search over pump speeds
    # and drag‐reduction levels.  A smaller RPM step (e.g. 25) permits the
    # optimiser to explore speeds between the minimum and DOL speeds, while a
    # drag‑reduction step of 1 allows 1 % increments in DRA injection.  These
    # values can be tuned further if necessary.
    RPM_STEP = 25  # RPM step size for discretisation
    DRA_STEP = 1    # DRA step size (ppm)
